...
public class DarkKnight extends NonPlayableCharacter {
    ...
    private float hitCooldown = 1.0f; // Cooldown in seconds for each hit
    ...
    public DarkKnight(String name, int hp, int level, int damage, World world, Vector2 position, float startX, float startY, float width, float height) {
        super(world, position, "DarkKnight", false);
        this.hp = 100;
        this.damage = 15;
        ...
        TextureSilver = new Texture(Gdx.files.internal("DarkKnight.png"));
    }
