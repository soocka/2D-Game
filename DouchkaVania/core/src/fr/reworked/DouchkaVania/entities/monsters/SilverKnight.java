...
public class SilverKnight extends NonPlayableCharacter {
    ...
    public SilverKnight(String name, int hp, int level, int damage, World world, Vector2 position, float startX, float startY, float width, float height) {
        super(world, position, "SilverKnight", false);
        this.hp = 100;
        this.damage = 15;
        ...
        TextureSilver = new Texture(Gdx.files.internal("SILVERKNIGHT.png"));
    }
